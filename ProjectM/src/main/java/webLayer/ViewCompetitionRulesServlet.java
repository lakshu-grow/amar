...
@WebServlet("/ViewCompetitionRulesServlet")
public class ViewCompetitionRulesServlet extends HttpServlet {
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html><head><title>View Competition Rules</title>");
            out.println("<link rel='stylesheet' href='style.css'></head>");
            out.println("<body class='view-competition-page'>");
